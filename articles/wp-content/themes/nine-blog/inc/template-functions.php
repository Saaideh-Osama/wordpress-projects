 ...
 * @return array
 */
function nine_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'nine_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function nine_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'nine_blog_pingback_header' );

/**
 * nine_blog Excerpt Length
 *
 * @since nine_blog 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'nine_blog_excerpt_length' ) ) :
   ...
   */
  function nine_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'nine_blog_excerpt_length', 999 );
